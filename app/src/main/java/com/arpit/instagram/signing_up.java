...
public class signing_up extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case R.id.btnsignup:
                ...
                {
                    FancyToast.makeText(signing_up.this, "Email,Username, and Password is required",
                ...
                break;
            case R.id.btnlogin:
                Intent intent = new Intent(signing_up.this,login.class);
